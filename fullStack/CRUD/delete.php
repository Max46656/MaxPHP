...
if (isset($_POST['action']) && $_POST['action'] == 'delete') {
    $sql_update = "
delete from  `members`  WHERE m_id=%s
  ";
    $sql_update = sprintf($sql_update, $_POST['m_id']);
    // echo $sql_update;
...
<body>
  ...
  <form action='delete.php' method='POST' name='formDelete' onsubmit="return confirm('\n是否要刪除這筆資料?\n刪除後無法恢復喔!\n')">
    ...
    echo " checked";}?>>否
      ...
      <tr>
        <td colspan='2' align='center'>
          ...
          <input type='submit' name='btnAdd' value='刪除資料'>
